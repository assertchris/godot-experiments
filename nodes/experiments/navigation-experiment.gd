...
@onready var _player := $Player as Sprite2D
@onready var _agent := $Player/NavigationAgent2D as NavigationAgent2D
@onready var _destination := $Position2D as Position2D
